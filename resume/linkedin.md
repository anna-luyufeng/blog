...
```
* Before 2018, built over 30 websites by using Joomla! (open-source content management system).
...
• Achieved efficient communication with back-end engineers by defining RESTFul APIs using Postman Mock Server.
• Documented project specifications to consolidate the information with project managers.
• Accelerated development by designing reusable UI components for listing and editing data.
